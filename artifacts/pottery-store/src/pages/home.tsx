...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero */}
      <section className="relative overflow-hidden bg-gradient-to-br from-amber-50 to-orange-50 dark:from-stone-900 dark:to-stone-800 min-h-[85vh] flex items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            {featured && featured.length > 0 ? (
                ...
                <Link key={product.id} href={`/products/${product.id}`}>
                  ...
                  >
                    {product.images[0] ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-amber-100 to-orange-200 dark:from-stone-700 dark:to-stone-600" />
                    )}
              ...
              <>
                <div className="row-span-2 rounded-xl bg-gradient-to-br from-amber-100 to-orange-200 dark:from-stone-700 dark:to-stone-600 aspect-square animate-pulse" />
                <div className="rounded-xl bg-gradient-to-br from-sand-100 to-amber-100 dark:from-stone-700 dark:to-stone-600 aspect-square animate-pulse" />
                <div className="rounded-xl bg-gradient-to-br from-orange-100 to-red-100 dark:from-stone-700 dark:to-stone-600 aspect-square animate-pulse" />
              </>
            )}
          </motion.div>
        </div>
